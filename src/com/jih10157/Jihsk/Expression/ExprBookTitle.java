...
public class ExprBookTitle extends SimpleExpression<String> {
    static {
        Skript.registerExpression(ExprBookTitle.class, String.class, ExpressionType.SIMPLE, "[jih[sk].[ ]][the] [book['s]] title of %itemstack%", "[jih[sk].[ ]]%itemstack%'s [book] title");
        Main.Expramount++;
    }
    ...
    public String toString(@Nullable Event e, boolean arg1) { return "Jihsk ExprBookTitle"; }
